# crm+ev_leads — assembled app

Customer relationship manager: contacts, pipelines, activity log, reporting.

Domain: **EV Charger Installation Leads**. See DOMAIN.md for entities/workflows to scaffold.
