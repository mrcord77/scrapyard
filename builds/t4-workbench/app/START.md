# agent_platform+research_workbench — assembled app

LLM agent product: tool-using agents, RAG, streaming, cost logging, evals.

Domain: **AI Research Workbench**. See DOMAIN.md for entities/workflows to scaffold.
...
- `scrapyard.ai.chunking`
- `scrapyard.ai.embeddings`
- `scrapyard.ai.llm_client`
...
- 48 of 48 copied parts are verified core (metadata present, imports OK, no hollow NotImplementedError) per tools/index_catalog.py.
