# Build plan — course_platform + education
Stage **mvp**, mode **GATE**.

- Pattern inheritance: course_platform
- Domain inheritance: education
- Parts resolved: 52
...
- Validation: **WARN**
- Fitness: **FIT**
- Behavior verification: VERIFIED (20 behaviors proven, 0 failed)
- Workflow verification: **4 verified**, 0 blocked (stub-dependent), 0 failed
- Plan confidence: avg **0.8** (proven 49, unknown 3)
