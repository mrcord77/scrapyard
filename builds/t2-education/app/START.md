# course_platform+education — assembled app

Online courses: lessons, enrollment, progress, payments, certificates.

Domain: **Learning / courses**. See DOMAIN.md for entities/workflows to scaffold.
