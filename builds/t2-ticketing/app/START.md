# ticketing_system+construction — assembled app

Support/issue tracking: tickets, assignment, SLAs, notifications, audit trail.

Domain: **Construction project management**. See DOMAIN.md for entities/workflows to scaffold.
