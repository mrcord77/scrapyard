# saas_subscription_app+sobriety — assembled app

Multi-tenant subscription SaaS: auth, RBAC, Stripe billing, admin, the works.

Domain: **Recovery / sobriety support**. See DOMAIN.md for entities/workflows to scaffold.
...
- 78 of 78 copied parts are verified core (metadata present, imports OK, no hollow NotImplementedError) per tools/index_catalog.py.
