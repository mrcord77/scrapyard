# Capabilities — marketplace + ecommerce
...
- `GET|POST /products`, `GET|PUT|DELETE /products/{id}` — Product CRUD (auth required (shared across users))
- `GET|POST /variants`, `GET|PUT|DELETE /variants/{id}` — Variant CRUD (auth required (shared across users))
- `GET|POST /carts`, `GET|PUT|DELETE /carts/{id}` — Cart CRUD (auth required (shared across users))
- `GET|POST /orders`, `GET|PUT|DELETE /orders/{id}` — Order CRUD (auth required (shared across users))
- `GET|POST /shipments`, `GET|PUT|DELETE /shipments/{id}` — Shipment CRUD (auth required (shared across users))
