# Build report — Property listings / brokerage

Domain `real_estate` · data sensitivity **moderate**.
...
- Indexed (owner/external, no FK): `client_id`
- Workflow: no
