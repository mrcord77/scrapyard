# web_application+task_tracker — assembled app

Any web app: foundation, HTTP API, persistence, baseline security.

Domain: **Personal Task Tracker**. See DOMAIN.md for entities/workflows to scaffold.
...
- 30 of 30 copied parts are verified core (metadata present, imports OK, no hollow NotImplementedError) per tools/index_catalog.py.
