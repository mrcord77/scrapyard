# web_application+bikeshop — assembled app

Any web app: foundation, HTTP API, persistence, baseline security.

Domain: **Bicycle Repair Shop**. See DOMAIN.md for entities/workflows to scaffold.
...
- 32 of 32 copied parts are verified core (metadata present, imports OK, no hollow NotImplementedError) per tools/index_catalog.py.
