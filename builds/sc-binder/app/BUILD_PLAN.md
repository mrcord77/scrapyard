# Build plan — documentation_site + iep_binder
Stage **growth**, ~5000 users, mode **GATE**.

- Pattern inheritance: documentation_site
- Domain inheritance: iep_binder
- Parts resolved: 31
...
- Validation: **FAIL**
- Fitness: **FIT**
- Behavior verification: VERIFIED (15 behaviors proven, 0 failed)
- Workflow verification: **4 verified**, 0 blocked (stub-dependent), 0 failed
- Plan confidence: avg **0.85** (proven 31)
