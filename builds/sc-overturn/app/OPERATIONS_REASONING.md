...
```
OPERATIONAL REASONING — saas_subscription_app+appeal_fighter
...
Failure reasoning (each external dep that this build leans on):
  db_session [high] -> breaks in-plan: account_deletion, data_export, audit_logs, email_verification, password_reset, stripe_webhooks, subscription_status, entitlement_gate, subscriptions, stripe_checkout, session_manager, auth_routes, app_factory
