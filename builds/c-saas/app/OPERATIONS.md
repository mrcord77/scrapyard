...
## stripe_webhooks
- **Cost:** low
- **Scaling limit:** fine; bursty on billing cycles
- **Failure modes:** replayed events, missed events, signature bypass
- **Monitor:** webhook failures, signature mismatches
- **Backup:** log raw events  •  **Recovery:** replay from Stripe dashboard
- **Recommended stage:** mvp  •  **Avoid when:** you are not taking payments
