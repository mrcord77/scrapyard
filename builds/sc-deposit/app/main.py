...
app = bootstrap(
    ...
    security_caps=['account_deletion', 'session_manager', 'users'],
)
...
# --- product-specific glue: itemized dispute letter (custom code, ~70 lines) ---
from custom_letter import router as _letter_router
app.include_router(_letter_router)
